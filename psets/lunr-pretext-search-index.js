...
},
{
  ...
  "number": "",
  "title": "Problem Set 3",
  "body": " Problem Set 3  Trigonometric Substitution and Partial Fractions   This problem set consists not only of problems similar to what you've seen, but also of unique problems you may not have seen before. The purpose of the latter is for you to apply the concepts you've previously learned to new, unfamiliar, and usually more interesting situations. In some cases, problems connect ideas from multiple learning objectives.  Write full, clear solutions to the problems below. It is important that the logic of how you solved these problems is clear. Although the final answer is important, being able to convey you understand the underlying concepts is more important.  Prepare a single PDF and submit it to Gradescope.      Evaluate the definite integral . Explain your steps and justify your choices for trigonometric substitution.      Evaluate the indefinite integral .      Evaluate the indefinite integral .      Evaluate the indefinite integral .      Evaluate the indefinite integral .      Evaluate the indefinite integral .     "
},
{
